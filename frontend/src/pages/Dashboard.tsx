    ...
    <Layout>
      ...
      <h1 className="text-green-400 text-2xl font-bold mb-4">Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#FFFAFB] p-4 rounded-lg shadow-lg">
            <h2 className="text-lg font-semibold">Status Devices</h2>
            <div className="flex justify-between mt-4">
              <div className="bg-green-400 p-4 rounded-lg">Active 13</div>
              <div className="bg-red-400 p-4 rounded-lg">Inactive 30</div>
            </div>
          </div>

          <div className="bg-[#1A3B6D] p-4 rounded-lg shadow-lg">
        ...
        <div className="bg-[#1A3B6D] p-4 rounded-lg shadow-lg mt-6">
